...
class BoardController: NSObject,
  ...
  private func applyNumLettersSettings(with settings: [String: Any]) {
    // START YOUR CODE HERE
      guard let numLettersValue = settings[kNumLettersKey] as? Int else {
          return
      }
  ...
  private func applyNumGuessesSettings(with settings: [String: Any]) {
    // START YOUR CODE HERE
      guard let numGuessesValue = settings[kNumGuessesKey] as? Int else {
          return
      }
  ...
  private func applyThemeSettings(with settings: [String: Any]) {
    // START YOUR CODE HERE
      guard let wordThemeValue = settings[kWordThemeKey] as? String else {
          return
      }
      let theme = WordTheme(rawValue: wordThemeValue)
  ...
  private func applyIsAlienWordleSettings(with settings: [String: Any]) {
    // START YOUR CODE HERE
      guard let alienValue = settings[kIsAlienWordleKey] as? Bool else {
          return
      }
      isAlienWordle = alienValue
      print(goalWord)
    // START YOUR CODE HERE
  }
}
